  ...
  getBaoGong:function(){
    var _this = this
      ...
      if(_this.data.header_list.dh != ''){
        sql1 = "select dh,khmc,zdyh,shengchanbianhao,xm,dl,mcsl as mccl,mccl,jd,fqrq from baogongmingxi where dh = '" + _this.data.header_list.dh + "' and mccl <> '' order by fqrq"
        console.log(sql1)
...
var second = now.getSeconds(); // 秒钟
    ...
    tableShow1: function (e) {
      ...
      console.log(_this.data.header_list.dh)
      if(_this.data.header_list.dh != ''){
        sql1 = "select dh,khmc,zdyh,shengchanbianhao,xm,dl,mccl,jd,fqrq from baogongmingxi where dh = '" + _this.data.header_list.dh + "' and mccl <> '' order by fqrq"
        console.log(sql1)
      wx.cloud.callFunction({
        name: 'sqlServer_tb3999803',
        data: {
