...
Page({
  ...
  kehu_qiankuan_goto:function(){
    var _this = this
    wx.navigateTo({
      url: '../kehu_qiankuan_tongji/kehu_qiankuan_tongji?userInfo=' + JSON.stringify(_this.data.userInfo),
    })
  },
  ...
  gongyingshang_qiankuan_goto:function(){
    var _this = this
    wx.navigateTo({
      url: '../gongyingshang_qiankuan_tongji/gongyingshang_qiankuan_tongji?userInfo=' + JSON.stringify(_this.data.userInfo),
    })
  },
  ...
  dingdan_goto:function(){
    ...
    wx.navigateTo({
      url: '../xiaoshou_dingdan/xiaoshou_dingdan?userInfo=' + JSON.stringify(_this.data.userInfo) + "&tiaojian=" + JSON.stringify(tiaojian),
    })
  },
  ...
  chuku_goto:function(){
    ...
    wx.navigateTo({
      url: '../xiaoshou_chuku/xiaoshou_chuku?userInfo=' + JSON.stringify(_this.data.userInfo) + "&tiaojian=" + JSON.stringify(tiaojian),
    })
  },
  ...
  shoukuan_goto:function(){
    ...
    var tiaojian = {
      ...
      wx.navigateTo({
        url: '../caigou_fukuan/caigou_fukuan?userInfo=' + JSON.stringify(_this.data.userInfo) + "&shouzhi_type=收入记录" + "&tiaojian=" + JSON.stringify(tiaojian),
      })
  },
  ...
  maoli_goto:function(){
    ...
    wx.navigateTo({
      url: '../maoli_tongji/maoli_tongji?userInfo=' + JSON.stringify(_this.data.userInfo) + "&tiaojian=" + JSON.stringify(tiaojian),
    })
  },
  ...
  xiaoshou_dingdan_goto:function(){
    ...
    wx.navigateTo({
      url: '../xiaoshou_dingdan_tongji/xiaoshou_dingdan_tongji?userInfo=' + JSON.stringify(_this.data.userInfo) + "&tiaojian=" + JSON.stringify(tiaojian),
    })
  },
  ...
  xiaoshou_shoukuan_goto:function(){
    ...
    wx.navigateTo({
      url: '../xiaoshou_shoukuan_tongji/xiaoshou_shoukuan_tongji?userInfo=' + JSON.stringify(_this.data.userInfo) + "&tiaojian=" + JSON.stringify(tiaojian),
    })
  },
