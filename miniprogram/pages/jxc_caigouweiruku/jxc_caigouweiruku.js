 ...
 down:function(){
  ...
  upd: function (e) {
    ...
    if(id != undefined){
      ...
      console.log(uid)
      wx.navigateTo({
        url: '/pages/caigouweiruku_update/caigouweiruku_update?id=' + uid + '&fun=update',
      })
    }else{
