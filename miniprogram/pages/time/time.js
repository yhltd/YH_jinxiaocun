              ...
              if(app.globalData.shujuku==0){
                ...
                wx.cloud.callFunction({
                  ...
                  success(res) {
                    ...
                    //     name: "sqlServer_117",
                    //     data: {
                    //       query: "select *,0 as isSelect,ISNULL((select sum(CASE mxtype WHEN '入库' THEN cpsl ELSE (cpsl*-1) END) from yh_jinxiaocun_excel.dbo.yh_jinxiaocun_mingxi_mssql where cpname = j.name and gs_name = '"+gongsi+"'),0) as allSL from yh_jinxiaocun_excel.dbo.yh_jinxiaocun_jichuziliao_mssql as j where gs_name = '"+gongsi+"'"
                    //     },
                    //     success(res) {
                    ...
                    //       }
                    //       that.setData({
                    //         shangpin_list: res.result.recordset,
