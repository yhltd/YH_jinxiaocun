...
Page({
  ...
  changed: function (e) {
    ...
    if (new_value != "" || column == "ddh"
      || column == "syy" || column == "hyxm"){
    var sql = "update orders set riqi='" + _this.data.riqi + "', ddh='" + _this.data.ddh + "', hyzh='" + _this.data.hyzh + "', hyxm='" + _this.data.hyxm + "', yhfa='" + _this.data.yhfa + "', ssje='" + _this.data.ssje + "', yhje='" + _this.data.yhje + "', syy='" + _this.data.syy + "' where id='" + _this.data.list[index].id + "';"
    wx.cloud.callFunction({
      name: 'sqlserver_xinyongka',
      data: {
        sql: sql
  ...
  add: function(e) {
    ...
    if (e.detail.value.riqi !="" && e.detail.value.ddh != "" && e.detail.value.hyzh != "" && e.detail.value.hyxm != "" && e.detail.value.hyjf != "" && e.detail.value.yhfa != "" && e.detail.value.xfje != "" && e.detail.value.ssje != "" && e.detail.value.yhje != "" && e.detail.value.syy != ""){
    let sql = "insert into orders(riqi,ddh,hyzh,hyxm,hyjf,yhfa,xfje,ssje,yhje,syy,company) values('" + e.detail.value.riqi + "','" +
      e.detail.value.ddh + "','" + e.detail.value.hyzh + "','" + e.detail.value.hyxm + "','" +
      e.detail.value.hyxm + "','" + e.detail.value.hyjf + "'," + e.detail.value.yhfa + "','" + e.detail.value.xfje + "','" + e.detail.value.ssje + "','" + e.detail.value.yhje + "','"+ e.detail.value.syy + "','" + _this.data.company + "')"
    wx.cloud.callFunction({
      name: 'sqlserver_xinyongka',
      data: {
        sql: sql
  ...
  init: function() {
    ...
    var end_date = _this.data.end_date;
    if (start_date==""){
