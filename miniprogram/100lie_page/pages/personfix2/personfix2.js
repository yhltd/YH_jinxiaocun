...
Page({
  ...
  onLoad: function (options) {
    ...
    var sql = "select B from baitaoquanxian_copy1 where quanxian = '" + _this.data.userInfo.B + "' group by B"
    wx.cloud.callFunction({
      name: 'sqlServer_117',
      data:{
        query : sql
      ...
      success(res){     
        var renyuan = res.result.recordset
        var renyuan_select = []
  ...
  bindPickerChange1: function(e) {
    ...
    _this.setData({
      renyuan_name: _this.data.renyuan_select[e.detail.value]
    })
    _this.sel()
  },
  ...
  click:function(e){
    ...
    var sql = "update baitaoquanxian_copy1 set " + colmun + "='" + this_val + "' where id =" + list[index].id
    wx.cloud.callFunction({
      name: 'sqlServer_117',
      data:{
        query: sql
  ...
  sel:function(){
    ...
    var sql = "select * from baitaoquanxian_copy1 where quanxian = '" + _this.data.gongsi + "' and B='" + _this.data.renyuan_name + "'"
    wx.cloud.callFunction({
      name: 'sqlServer_117',
      data:{
        query : sql
