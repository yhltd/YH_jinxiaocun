  ...
  onLoad: function (options) {
    ...
    if(app.globalData.shujuku==0){
      ...
      wx.cloud.callFunction({
        name: 'sqlServer_117',
        data: {
          query: "select * from xueshengguanlixitong_excel.dbo.power where Company = '" + userInfo.Company + "' and t_id = " + userInfo.ID + " and view_name ='权限管理'"
        },
        success: res => {
          console.log(res.result.recordset)
          var list = res.result.recordset
    ...
    if (_this.data.xm != "" ) {
      ...
      if(app.globalData.shujuku==0){
        ...
        wx.cloud.callFunction({
          name: 'sqlServer_117',
          data: {
            query: "insert into xueshengguanlixitong_excel.dbo.power (t_id,view_name,[add],del,upd,sel,company) values('" + _this.data.t_id + "','" + _this.data.ymmc + "','" + _this.data.zeng + "','" + _this.data.shan + "','" + _this.data.gai + "','" + _this.data.cha + "','" + user + "')"
          },
          success: res => {
            _this.setData({
              xm: "",
    ...
    if (_this.data.xm != "") {
      ...
      if(app.globalData.shujuku==0){
        ...
        wx.cloud.callFunction({
          name: 'sqlServer_117',
          data: {
            query: "update xueshengguanlixitong_excel.dbo.power set view_name='" + _this.data.ymmc + "', [add]='" + _this.data.zeng + "',del='" + _this.data.shan + "',upd='" + _this.data.gai + "',sel='" + _this.data.cha + "' where id=" + _this.data.id
          },
          success: res => {
            _this.setData({
              xm: "",
  ...
  del1:function(){
    ...
    if(app.globalData.shujuku==0){
      ...
      wx.cloud.callFunction({
        name: 'sqlServer_117',
        data: {
          query: "delete from xueshengguanlixitong_excel.dbo.power where id='" + _this.data.id + "'"
        },
        success: res => {
          _this.setData({
            rq: "",
