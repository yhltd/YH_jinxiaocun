  ...
  tableShow: function (e) {
    ...
    if(app.globalData.shujuku==0){
      ...
      wx.cloud.callFunction({
        name: 'sqlServer_117',
        data: {
          query: "select teacher_name,course,keshi,jine,keshi*jine as gongzihesuan from xueshengguanlixitong_excel.dbo.keshi_detail where riqi >= '" + e[0] + "' and riqi <= '" + e[1] + "' and teacher_name like '%" + e[2] + "%' and Company='" + user + "'"
        },
        success: res => {
  ...
  onLoad: function (options) {
    ...
    if(app.globalData.shujuku==0){
      ...
      wx.cloud.callFunction({
        name: 'sqlServer_117',
        data: {
          query: "select * from xueshengguanlixitong_excel.dbo.power where Company = '" + userInfo.Company + "' and t_id = " + userInfo.ID + " and view_name ='教师工资'"
        },
        success: res => {
          console.log(res.result.recordset)
          var list = res.result.recordset
