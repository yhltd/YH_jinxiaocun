  ...
  tableShow: function (e) {
    ...
    if(app.globalData.shujuku==0){
      ...
      wx.cloud.callFunction({
        name: 'sqlServer_117',
        data: {
          query: "select * from xueshengguanlixitong_excel.dbo.keshi_detail where teacher_name like '%" + e[0] + "%' and course like '%" + e[1] + "%' and riqi >= '" + e[2] + "' and riqi <= '" + e[3] + "' and Company='" + user + "'"
        },
        success: res => {
  ...
  onLoad: function (options) {
    ...
    if(app.globalData.shujuku==0){
      ...
      wx.cloud.callFunction({
        name: 'sqlServer_117',
        data: {
          query: "select * from xueshengguanlixitong_excel.dbo.power where Company = '" + userInfo.Company + "' and t_id = " + userInfo.ID + " and view_name ='课时统计'"
        },
        success: res => {
