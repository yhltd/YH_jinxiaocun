...
Page({
  ...
  upd1:function(){
    ...
    wx.cloud.callFunction({
      name: 'sqlserver_huanchenmeng',
      data: {
        query: "update paiban_A set D='" + _this.data.D + "',E='" + _this.data.E + "',F='" + _this.data.F + "',G='" + _this.data.G + "',H='" + _this.data.H + "',I='" + _this.data.I + "',J='" + _this.data.J + "',K='" + _this.data.K + "',L='" + _this.data.L + "' where id=" + _this.data.id  
      },
      success: res => {
        _this.setData({
            id:'',
